import{_}from"./CB9z4_ed.js";import{d as m,r as f,c as s,i as a,F as g,K as v,g as e,f as d,t as r,e as p,n as k,j as h}from"./zFJIPpoY.js";const y={class:"timeline"},w={class:"timeline-content card"},x={class:"visible-content"},j={class:"logo"},q={class:"d-flex justify-content-between"},A={class:"text-primary"},B=["innerHTML"],M={class:"text-secondary"},S={key:0,class:"timeline-duration"},C=["onClick","aria-label"],L={key:0,width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg"},D={key:1,width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg"},P=["innerHTML"],E={key:0},I=["href"],T=m({__name:"Timeline",props:{items:{}},setup(c){const t=f(new Set),u=n=>{t.value.has(n)?t.value.delete(n):t.value.add(n)};return(n,l)=>{const b=_;return a(),s("div",y,[(a(!0),s(g,null,v(n.items,(i,o)=>(a(),s("div",{key:o,class:"timeline-item"},[l[2]||(l[2]=e("div",{class:"timeline-marker"},null,-1)),e("div",w,[e("div",x,[e("div",j,[d(b,{src:i.logoPath,alt:"logo"},null,8,["src"])]),e("div",q,[e("div",null,[e("h3",A,r(i.title),1),e("h4",{class:"text-normal",innerHTML:i.subtitle},null,8,B),e("div",M,[e("span",null,r(i.period),1),i.duration?(a(),s("span",S,r(i.duration),1)):p("",!0)])]),e("div",null,[e("button",{onClick:z=>u(o),class:"collapse-button","aria-label":t.value.has(o)?"Réduire":"Développer"},[t.value.has(o)?(a(),s("svg",L,l[0]||(l[0]=[e("path",{d:"M5 12H19",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"},null,-1)]))):(a(),s("svg",D,l[1]||(l[1]=[e("path",{d:"M12 5V19M5 12H19",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"},null,-1)])))],8,C)])])]),e("div",{class:k(["description",{expanded:t.value.has(o)}])},[e("div",{innerHTML:i.description},null,8,P),i.website?(a(),s("div",E,[e("a",{href:i.website,target:"_blank"},"Visiter le site",8,I)])):p("",!0)],2)])]))),128))])}}}),J=h(T,[["__scopeId","data-v-444ff4c3"]]),$=m({__name:"Experiences",setup(c){const t=[{title:"Medialeads - Bayonne",subtitle:"Alternance - Développement web Symfony",period:"Septembre 2023 - Septembre 2025 (2 ans)",logoPath:"/logos/medialeads.webp",website:"https://medialeads.fr/",description:`
    <p>
  ...
  `},{title:"ESIEA - Dax",subtitle:"BAC+5 - Expert en ingénierie du logiciel",period:"Septembre 2023 - Septembre 2025 (2 ans)",logoPath:"/logos/esiea.jpg",website:"https://esiea.fr/",description:`
    ...
    `}];return(u,n)=>{const l=J;return a(),s(g,null,[n[0]||(n[0]=e("h2",null,"Mon parcours",-1)),d(l,{items:t})],64)}}}),G={},V={id:"about-header"},H={id:"experiences"};function R(c,t){const u=$;return a(),s("div",null,[e("section",V,[e("h1",null,[e("div",null,r(c.$t("welcome_1")),1),e("div",null,r(c.$t("welcome_2")),1)])]),e("section",H,[d(u)])])}const O=h(G,[["render",R]]);export{O as default};
